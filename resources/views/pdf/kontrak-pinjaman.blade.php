...
<body>
    ...
    <div class="article">
        ...
        <ol>
            ...
            <li>PIHAK PERTAMA menyetujui bahwa dana sebesar Rp {{ number_format($angsuran_per_bulan, 0, ',', '.') }} (setara dengan 1 {{ $pinjaman->jangka_waktu_satuan }} angsuran) akan ditahan <b>(hold)</b> di dalam sistem KOPERASI SINARA ARTHA NAYA sebagai jaminan pembayaran angsuran ( kecuali <b>PINJAMAN INSTANT</b>).</li>
