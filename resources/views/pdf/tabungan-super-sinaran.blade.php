...
<body>
    ...
    <div class="section">
        ...
        <ol>
            ...
            <li>Penarikan simpanan dapat dilakukan setelah kontrak berakhir dan TIDAK memiliki tanggungan pinjaman ( jika ada )</li>
            <li>Penutupan Rekening akan dikenakan biaya sebesar 1% dari saldo yang ditarik.</li>
            <li>Rekening yang tidak aktif selama 12 bulan berturut-turut atau saldo minimal Rp.50.000 akan dinyatakan dormant.</li>
