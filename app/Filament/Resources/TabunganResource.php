                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div style="margin-top: 8px; color: #c2410c !important; font-size: 13px; line-height: 1.5;">
                                                <p style="margin-bottom: 6px;">• Untuk produk <strong style="color: #9a3412 !important;">Simpanan Kerta Sinara</strong> pastikan diawali dengan kode <code style="background: #fb923c !important; color: #9a3412 !important; padding: 4px 8px; border-radius: 6px; font-family: ui-monospace, monospace; font-weight: 500;">1111-xxxxx</code></p>
                                                <p style="margin-bottom: 6px;">• Untuk produk <strong style="color: #9a3412 !important;">Simpanan Kerta Artha</strong> pastikan diawali dengan kode <code style="background: #fb923c !important; color: #9a3412 !important; padding: 4px 8px; border-radius: 6px; font-family: ui-monospace, monospace; font-weight: 500;">2222-xxxxx</code></p>
                                                <p style="margin-bottom: 6px;">• Untuk produk <strong style="color: #9a3412 !important;">Simpanan Kerta Naya</strong> pastikan diawali dengan kode <code style="background: #fb923c !important; color: #9a3412 !important; padding: 4px 8px; border-radius: 6px; font-family: ui-monospace, monospace; font-weight: 500;">3333-xxxx</code></p>
