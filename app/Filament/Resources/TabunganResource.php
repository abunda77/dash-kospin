                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div style="margin-top: 8px; color: #c2410c !important; font-size: 13px; line-height: 1.5;">
                                                <p style="margin-bottom: 6px;">• Untuk produk <strong style="color: #9a3412 !important;">Simpanan Hallo Sinaran</strong> pastikan diawali dengan kode <code style="background: #fb923c !important; color: #9a3412 !important; padding: 4px 8px; border-radius: 6px; font-family: ui-monospace, monospace; font-weight: 500;">1111-xxxxx</code></p>
                                                <p style="margin-bottom: 6px;">• Untuk produk <strong style="color: #9a3412 !important;">Simpanan Super Sinaran</strong> pastikan diawali dengan kode <code style="background: #fb923c !important; color: #9a3412 !important; padding: 4px 8px; border-radius: 6px; font-family: ui-monospace, monospace; font-weight: 500;">2222-xxxxx</code></p>
                                                <p style="margin-bottom: 6px;">• Untuk produk <strong style="color: #9a3412 !important;">Simpanan VP Sinaran</strong> pastikan diawali dengan kode <code style="background: #fb923c !important; color: #9a3412 !important; padding: 4px 8px; border-radius: 6px; font-family: ui-monospace, monospace; font-weight: 500;">3333-xxxx</code></p>
