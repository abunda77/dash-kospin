...
class CriticalOverdueWidget extends BaseStatsOverviewWidget
{
    ...
    protected ?string $heading = 'Risiko Pinjaman';

    protected ?string $description = 'Pemantauan pinjaman dengan keterlambatan lebih dari 90 hari.';
    ...
    public static function canView(): bool
    {
        ...
        return $user && Gate::forUser($user)->allows('page_ListKeterlambatan90Hari');
    }
}
